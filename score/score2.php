                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <?php if ($arr2['faculty_id1'] != "0") { ?><a href="index.php?menu=result_team2&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id1']; ?>&STID=<?php echo $arr2['id_Sports_category']; ?>&go=fixture&sex=<?php echo $sex_type;?>"><?php echo $faculty1['subname_university'] . " " . "มือ" . " " . $faculty1['hand_ranks'];
                                    } ?>
                                  </td>
                                  <td align="center">
                                                ...
                                                <table width="100%" border="0">
                                                  <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <?php if ($arr2['faculty_id1'] != "0") { ?><a href="index.php?menu=result_team2&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id1']; ?>&STID=<?php echo $arr2['id_Sports_category']; ?>&go=fixture&sex=F"><?php echo $faculty1['subname_university'] . " " . "มือ" . " " . $faculty1['hand_ranks'];
                                                    ...
                                                    <td><?php
                                                        ...
                                                        if ($arr2['faculty_id2'] != "0") { ?><a href="index.php?menu=result_team2&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id2']; ?>&STID=<?php echo $arr2['id_Sports_category']; ?>&go=fixture&sex=F"><?php echo $faculty2['subname_university'] . " " . "มือ" . " " . $faculty2['hand_ranks'];
                                                      ?></td>
                                                  </tr>
                                                  <?php
                                  ...
                                  <td>
                                    ...
                                    if ($arr2['faculty_id2'] != "0") { ?>
                                      <a href="index.php?menu=result_team2&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id2']; ?>&STID=<?php echo $arr2['id_Sports_category']; ?>&go=fixture&sex=F">
                                      <?php echo $faculty2['subname_university'] . " " . "มือ" . " " . $faculty2['hand_ranks'];
