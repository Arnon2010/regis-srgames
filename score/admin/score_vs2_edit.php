...
?>
        ...
        <center>
          <h3><a href=""><i class="fa fa-edit"></i>&nbsp;แก้ไขข้อมูลการแข่งขันแบบ VS</a></h3></center><br />
            ...
            <form name="frm_regis" method="post" action="score_vs2_edit_save.php?ID=<?php echo $_GET['ID'];?>&sport_type=<?php echo $_GET['sport_type']?>&sport_name=<?php echo $_GET['sport_name']?>" onSubmit="return check()" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    *
                    <select name="sport_type_id" id="sport_type_id" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      <?php
					  $sqlt = "select * from sports_category where status='3'";
                  ...
                  <div class="form-group">
                    <label>ประเภท<?php echo " ".$arr['sex'];?></label>
                  </div><!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select name="faculty_id1" id="faculty_id1" style="width:100%" class="form-control select2" >
                      ...
                      $sql11 = "select * from university where id_university = '".$arr1['id_university']."'";
					  $qr11 = mysql_query($sql11);
					  $arr11 = mysql_fetch_array($qr11);
					  
					  $sql111 = "select * from sports_category where id_Sports_category = '".$arr1['id_Sports_category']."'";
					  $qr111 = mysql_query($sql111);
					  $arr111 = mysql_fetch_array($qr111);
					  
					  
                      ?>
                      
                      <option <?php if($arr['faculty_id1']==$arr1['id_team']){?>selected="selected"<?php }?> value="<?php echo $arr1['id_team'];?>"><?php echo $arr11['name_university']." ".$arr111['name_Sports_category']."(".$arr1['sex'].")"."มือวางอันดับ".$arr1['hand_ranks'];?></option>
                  ...
                  <div class="form-group">
                    ...
                    <select name="faculty_id2" id="faculty_id2" style="width:100%" class="form-control select2" >
                      ...
                      $sql22 = "select * from university where id_university = '".$arr2['id_university']."'";
					  $qr22 = mysql_query($sql22);
					  $arr22 = mysql_fetch_array($qr22);
					  
					  $sql222 = "select * from sports_category where id_Sports_category = '".$arr2['id_Sports_category']."'";
                      ...
                      <option <?php if($arr['faculty_id2']==$arr2['id_team']){?>selected="selected"<?php }?> value="<?php echo $arr2['id_team'];?>"><?php echo $arr22['name_university']." ".$arr222['name_Sports_category']."(".$arr2['sex'].")"."มือวางอันดับ".$arr2['hand_ranks'];?></option>
