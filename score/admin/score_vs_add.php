...
?>
        ...
        <center>
          <h3><a href=""><i class="fa fa-edit"></i>&nbsp;เพิ่มข้อมูลการแข่งขันแบบ VS</a></h3></center><br />

            <form name="frm_regis" method="post" action="score_vs_add_save.php?sport_type=<?php echo $_GET['sport_type']?>&sport_name=<?php echo $_GET['sport_name']?>" onSubmit="return check()" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    *
                    <select name="line_id" id="line_id" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      {
                      ?>
                      <option value="<?php echo $arrline['line_id'];?>" <?php if($arrline['line_name'] == 'ไม่มี'){echo "selected";}?>>
                        <?php echo $arrline['line_name'];?></option>
                      <?php }?>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    *
                    <select name="sport_type_id" id="sport_type_id" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      <?php
                      $sql = "select * from sports_category where status='1' AND id_Sport_type = '$_GET[sport_type]' ";
                      $qr = mysql_query($sql);
                      while($arr = mysql_fetch_array($qr))
                      {
                      ?>
                      <option value="<?php echo $arr['id_Sports_category'];?>"><?php echo $arr['name_Sports_category'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select name="faculty_id2" id="faculty_id2" style="width:100%" class="form-control select2" >
                      ...
                      {
                      ?>
                      <option value="<?php echo $arr2['id_university'];?>"><?php echo $arr2['name_university'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    *
                    <select name="temporary2" id="temporary2" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      {
                      ?>
                      <option value="<?php echo $arr1temporary2['temporary_name'];?>" <?php if($arr1temporary2['temporary_name'] == 'ว่าง'){echo "selected";}?>>
