			...
			$sql = "select * from admin where admin_username = '$username' and admin_password = '$password'";
			 $query = mysql_query($sql,$conn) or die(mysql_error());
				$arr = mysql_fetch_array($query);
				 if($username==$arr['admin_username'] && $password==$arr['admin_password']){ 
				 $_SESSION['admin_id'] = $arr['admin_id'];
							 $_SESSION['admin_username'] = $arr['admin_username'];
							 $_SESSION['admin_type_id'] = $arr['admin_type_id'];
		...
		<div class="col-md-4">
			<div class="box box-primary">
				<div class="login-logo">
					<br>
					<a href="index2.html"><b>RUTS</b> scoregame</a>
				</div><!-- /.login-logo -->
				<div class="login-box-body">
					<p class="login-box-msg">Sign in to start your session</p>
					<form action="index.php?go=edit" method="post">
