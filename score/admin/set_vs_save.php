...
<?php
	...
	if($_GET['check']=="delete")
	{
		...
		$strsql2 = "delete from tb_set where tb_set_id = '".$_GET['ID2']."'";
		$query3 = mysql_query($strsql2) or die(mysql_error());
	
	$v1 = 0;
	$v2 = 0;
		$sqlvs = "select * from tb_set where score_vs_id='".$_GET['ID']."'";
	     ...
	     $strSQL = "update score_vs set score1 = '$v1',score2 = '$v2'  where score_vs_id = '".$_GET['ID']."'";
	...
	$strSQL = "INSERT INTO tb_set VALUES (Null,'$sport_type_id','$num_set','$score1','$score2')";
	$objQuery = mysql_query($strSQL);
