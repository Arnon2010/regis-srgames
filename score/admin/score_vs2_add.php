...
<!-- Main content -->
    <section class="content">
        ...
        <center>
          <h3><a href=""><i class="fa fa-edit"></i>&nbsp;เพิ่มข้อมูลการแข่งขันแบบ VS2</a></h3></center><br />
            
            <form name="frm_regis" method="post" action="">
                  <div class="form-group">
                    <label>เลือกประเภทกีฬา</label>
                    *
                    <select name="sport_type_id" id="sport_type_id" onchange="this.form.submit();" style="width:100%" class="form-control select2" required tabindex="1">
                      <option value="">----- กรุณาเลือกประเภทกีฬา -----</option>
                      <?php
                      $sql = "select * from sports_category where status='3' AND id_Sport_type = '$_GET[sport_type]'";
                      $qr = mysql_query($sql);
                      while($arr = mysql_fetch_array($qr))
                      {
                      ?>
                      <option value="<?php echo $arr['id_Sports_category'];?>" 
                        <?php if($arr['id_Sports_category'] == $_POST['sport_type_id']){ echo "selected";}?>
                      >
                          <?php echo $arr['name_Sports_category'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    *
                    <select name="sex" id="sex" onchange="this.form.submit();" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      <option value="คู่ผสม" <?php if($_POST['sex'] == 'คู่ผสม'){ echo "selected";}?>>คู่ผสม</option>
                  ...
                  <div class="form-group">
                    ...
                    *
                    <select name="round_id" id="round_id" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      {
                      ?>
                      <option value="<?php echo $arr['round_id'];?>"><?php echo $arr['round_name'];?></option>
                      <?php }?>
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    *
                    <select name="line_id" id="line_id" style="width:100%" class="form-control select2" required tabindex="1">
                      ...
                      {
                      ?>
                      <option value="<?php echo $arrline['line_id'];?>"><?php echo $arrline['line_name'];?></option>
                      <?php }?>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    $sql1 = "SELECT * FROM teamvs2 t 
                        LEFT JOIN sports_category c ON t.id_Sports_category = c.id_Sports_category 
                        LEFT JOIN university u ON t.id_university = u.id_university 
                        WHERE c.id_Sport_type = '$_GET[sport_type]' 
                        AND t.id_Sports_category = '$_POST[sport_type_id]' 
                        AND t.sex = '$_POST[sex]'
                        ";
                    //$sql1 = "select * from teamvs2";
                    $qr1 = mysql_query($sql1);
                    while($arr1 = mysql_fetch_array($qr1))
                    {
                    ?>
                  <option value="<?php echo $arr1['id_team'];?>"><?php echo '['.$arr1['subname_university'].']-'." ".$arr1['name_Sports_category']."(".$arr1['sex'].")"."มือวางอันดับ".$arr1['hand_ranks'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    *
                    <select name="temporary1" id="temporary1" style="width:100%" class="form-control select2" required tabindex="1">
                      <option value="">----- กรุณาเลือกทีมแข่งขันชั่วคราว 1 -----</option>
                      <?php
                      ...
                      {
                      ?>
                      <option value="<?php echo $arr1temporary1['temporary_name'];?>" 
                      <?php if($arr1temporary1['temporary_name'] == 'ว่าง'){ echo "selected";}?>
                      >
                      <?php echo $arr1temporary1['temporary_name'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <input name="score1" type="text" class="form-control" id="score1" >
                  </div><!-- /.form-group -->
                    ...
                    <select name="faculty_id2" id="faculty_id2" style="width:100%" class="form-control select2" >
                      ...
                      <?php
                        ...
                        ";
                          ...
                          {
                          ?>
                      <option value="<?php echo $arr2['id_team'];?>"><?php echo '['.$arr2['subname_university'].']-'." ".$arr2['name_Sports_category']."(".$arr2['sex'].")"."มือวางอันดับ".$arr2['hand_ranks'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
                  <div class="form-group">
                    ...
                    *
                    <select name="temporary2" id="temporary2" style="width:100%" class="form-control select2" required tabindex="1">
                      <option value="">----- กรุณาเลือกทีมแข่งขันชั่วคราว 2 -----</option>
                      <?php
                      ...
                      {
                      ?>
                      <option value="<?php echo $arr1temporary2['temporary_name'];?>"
                      <?php if($arr1temporary2['temporary_name'] == 'ว่าง'){ echo "selected";}?>
                      >
                      <?php echo $arr1temporary2['temporary_name'];?></option>
                      <?php }?>
                    </select>
                  </div><!-- /.form-group -->
            	  ...
            	  <div class="form-group">
                    ...
                    <input name="score2" type="text" class="form-control" id="score2" >
                  </div><!-- /.form-group -->
                  
                  <div class="form-group">
                    <label>เวลาการแข่งขัน</label>
                    *
                    <input name="times" type="time" class="form-control" id="times" required tabindex="1">
                  </div><!-- /.form-group -->
                  
                  <div class="form-group">
                    <label>วันที่การแข่งขัน</label>
                    *
                    <input name="date" type="date" class="form-control" id="date" required tabindex="1">
                  </div><!-- /.form-group -->
                  
              &nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="btnSubmit" class="btn btn-primary" value="บันทึก" />
              &nbsp;&nbsp;<button type="button" class="btn btn-primary" onclick="javascript:window.location='main.php?menu=score_vs'" />ย้อนกลับ </button>
              <br/>
                </form>
				</div><!-- /.box -->
              </div>
