...
<!-- Main content -->
        ...
        <center>
          <h3><a href=""><i class="fa fa-edit"></i>&nbsp;เพิ่มผลการแข่งขัน</a></h3></center><br />
            ...
            <form name="frm_regis" method="post" action="scor_vs_d_save.php?ID=<?php echo $_GET['ID']; ?>"  enctype="multipart/form-data">
             ...
             <div class="col-md-6">
              <div class="box box-primary">
                ...
                <h4><a href=""><i class="fa fa-edit"></i>&nbsp;เพิ่มผลการแข่งขันแบบ SET </a></h4>
                  <form name="frm_set" method="post" action="set_vs_save.php?ID=<?php echo $arr['score_vs_id']; ?>"  enctype="multipart/form-data">
                  <div class="form-group">
                    <label>set ที่:</label>
                    *
                  ...
                  <table  class="table table-bordered table-striped">
					...
					$sqlvs = "select * from tb_set where score_vs_id='".$arr['score_vs_id']."'";
                   ...
                   <td><a href="JavaScript:if(confirm('คูณต้องการลบข้อมูลใช่หรือไม่?')==true){window.location='set_vs_save.php?ID=<?php echo $arr['score_vs_id']; ?>&ID2=<?php echo $arrvs['tb_set_id']; ?>&check=delete'}" class="btn btn-app"><i class="fa fa-trash-o"></i> <span>ลบ</span></a></td>
                    <tr>
                    <?php } ?>
                    </tbody>
                    <tfoot>
