     ...
     <div class="content-header row">
       <div class="content-header-left col-md-6 col-12 mb-2">
         <h3 class="content-header-title">ตารางการแข่งขันกีฬา:<?php echo $sport_type['name_Sport_type']; ?>
            <a href="/schedule/<?php echo $_GET['ID'].'.pdf';?>" class="btn btn-info btn-sm" target="_bank"> | ดาวน์โหลด PDF</a></h3>
         <!-- <div class="row breadcrumbs-top">
           <div class="breadcrumb-wrapper col-12">
             <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
               </li>
               <li class="breadcrumb-item"><a href="index.php?menu=fixture&ID=<?php echo $_GET['ID']; ?>">ตารางการแข่งขันกีฬา:<?php echo $sport_type['name_Sport_type']; ?></a>
               </li>
                              ...
                              $temporary2 = mysql_fetch_array(mysql_query("select * from temporary where temporary_name = '".$arr2['temporary2']."'"));
        									  ...
        									  ?>
                                                     ...
                                                     <tr>
                                                       ...
                                                       <td>
                                                        <?php echo $sports_category['name_Sports_category']." ".$arr2['sex']." ".$line['line_name']; ?>
                                                        </td>

                                                       <td>
                                                           <?php if($arr2['faculty_id1']!="0"){?><a href="index.php?menu=result_team&ID=<?php echo $_GET['ID'];?>&FID=<?php echo $arr2['faculty_id1'];?>&STID=<?php echo $arrsport_type['id_Sports_category'];?>&go=fixture&sex=M"><?php echo $faculty1['subname_university']; if($arr2['temporary1']!="ว่าง"){ echo " (".$arr2['temporary1']." สาย".$line['line_name'].")";}?></a><?php }else{ echo $arr2['temporary1']; }?>
                                                           VS
                                                             <?php if($arr2['faculty_id2']!="0"){?><a href="index.php?menu=result_team&ID=<?php echo $_GET['ID'];?>&FID=<?php echo $arr2['faculty_id2'];?>&STID=<?php echo $arrsport_type['id_Sports_category'];?>&go=fixture&sex=M"><?php echo $faculty2['subname_university']; if($arr2['temporary2']!="ว่าง"){ echo " (".$arr2['temporary2']." สาย".$line['line_name'].")";}?></a><?php }else{ echo $arr2['temporary2']; }?>
                              ...
                              $temporary2 = mysql_fetch_array(mysql_query("select * from temporary where temporary_name = '".$arr2['temporary2']."'"));
        									  ...
        									  ?>
                                                     ...
                                                     <tr>
                                                       ...
                                                       <td>
                                                         <?php if($arr2['faculty_id1']!="0"){?><a href="index.php?menu=result_team&ID=<?php echo $_GET['ID'];?>&FID=<?php echo $arr2['faculty_id1'];?>&STID=<?php echo $arrsport_type['id_Sports_category'];?>&go=fixture&sex=F"><?php echo $faculty1['subname_university']; if($arr2['temporary1']!="ว่าง"){ echo " (".$arr2['temporary1']." สาย".$line['line_name'].")";}?></a><?php }else{ echo $arr2['temporary1']; }?>
                                                         VS
                                                           <?php if($arr2['faculty_id2']!="0"){?><a href="index.php?menu=result_team&ID=<?php echo $_GET['ID'];?>&FID=<?php echo $arr2['faculty_id2'];?>&STID=<?php echo $arrsport_type['id_Sports_category'];?>&go=fixture&sex=F"><?php echo $faculty2['subname_university']; if($arr2['temporary2']!="ว่าง"){ echo " (".$arr2['temporary2']." สาย".$line['line_name'].")";}?></a><?php }else{ echo $arr2['temporary2']; }?>
                                           </td>
                                ...
                                $temporary2 = mysql_fetch_array(mysql_query("select * from temporary where temporary_name = '".$arr2['temporary2']."'"));
          									  ...
          									  ?>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td>
                                                           <?php if($arr2['faculty_id1']!="0"){?><a href="index.php?menu=result_team&ID=<?php echo $_GET['ID'];?>&FID=<?php echo $arr2['faculty_id1'];?>&STID=<?php echo $arrsport_type['id_Sports_category'];?>&go=fixture&sex=MF"><?php echo $faculty1['subname_university']; if($arr2['temporary1']!="ว่าง"){ echo " (".$arr2['temporary1']." สาย".$line['line_name'].")";}?></a><?php }else{ echo $arr2['temporary1']; }?>
                                                           VS
                                                             <?php if($arr2['faculty_id2']!="0"){?><a href="index.php?menu=result_team&ID=<?php echo $_GET['ID'];?>&FID=<?php echo $arr2['faculty_id2'];?>&STID=<?php echo $arrsport_type['id_Sports_category'];?>&go=fixture&sex=MF"><?php echo $faculty2['subname_university']; if($arr2['temporary2']!="ว่าง"){ echo " (".$arr2['temporary2']." สาย".$line['line_name'].")";}?></a><?php }else{ echo $arr2['temporary2']; }?>
                                             </td>
