  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">ผลการแข่งขันกีฬา

          <?php if ($_GET['action'] != 'view') { ?>
            <a href="index.php?menu=showscore1&action=view" class="btn btn-secondary btn-sm">view</a>
          <?php } ?>
        </h3>
        <!-- <div class="row breadcrumbs-top">
           <div class="breadcrumb-wrapper col-12">
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item">ผลการแข่งขันกีฬา:
               </li>
             </ol>
           </div>
         </div> -->
        ...
        <div class="card-content collapse show">
          <div class="card-body">
            ...
            ?>
              ...
              ?>
                <a class="btn btn-social width-250 mr-1 mb-1 btn-dropbox" href="index.php?menu=score&action=view&ID=<?php echo $arrss['id_Sport_type']; ?>"><img src="mspig/<?php echo $arrss['id_Sport_type'] . ".png";  ?>" /><?php echo $arrss['name_Sport_type']; ?></a><?php  } else if ($arrss2['status'] == "2") { ?>
                <a class="btn btn-social width-250 mr-1 mb-1 btn-dropbox" href="index.php?menu=score1&action=view&ID=<?php echo $arrss['id_Sport_type']; ?>"><img src="mspig/<?php echo $arrss['id_Sport_type'] . ".png";  ?>" /><?php echo $arrss['name_Sport_type']; ?></a><?php  } else if ($arrss2['status'] == "3") { ?>
                <a class="btn btn-social width-250 mr-1 mb-1 btn-dropbox" href="index.php?menu=score2&action=view&ID=<?php echo $arrss['id_Sport_type']; ?>"><img src="mspig/<?php echo $arrss['id_Sport_type'] . ".png";  ?>" /><?php echo $arrss['name_Sport_type']; ?></a><?php  } ?>
            <?php } ?>
          </div>
        </div>
      </div>
