...
left join score_vs s ON c.id_Sports_category = s.sport_type_id 
              ...
              <div class="card-body  px-0 py-0">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      $sql2 = "SELECT * from score_vs where sport_type_id='" . $arrsport_type['id_Sports_category'] . "' 
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if ($arr2['faculty_id1'] != "0") { ?>
                              <a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $_GET['SVID']?>&FID=<?php echo $arr2['faculty_id1']; ?>&STID=<?php echo $arrsport_type['id_Sports_category']; ?>&go=fixture&sex=<?php echo $_GET['sex']; ?>"><?php echo $faculty1['subname_university'];
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <table width="100%" border="0">
                                          <tr>
                                            <td></td>
                                            <td> <?php if ($arr2['faculty_id1'] != "0") { ?><a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $_GET['SVID']?>&FID=<?php echo $arr2['faculty_id1']; ?>&STID=<?php echo $arrsport_type['id_Sports_category']; ?>&go=fixture&sex=<?php echo $_GET['sex']; ?>"><?php echo $faculty1['subname_university'];
                                              if ($arr2['temporary1'] != "ว่าง") {
                                                echo " (" . $arr2['temporary1'] . " สาย" . $line['line_name'] . ")";
                                              } ?></a><?php } else {                                                                                                                                                                                                                                                      
                                                echo $arr2['temporary1'];
                                            ...
                                            <td><?php if ($arr2['faculty_id2'] != "0") { ?>
                                            <a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']?>&SVID=<?php echo $_GET['SVID']?>&FID=<?php echo $arr2['faculty_id2']; ?>&STID=<?php echo $arrsport_type['id_Sports_category']; ?>&go=fixture&sex=<?php echo $_GET['sex']; ?>"><?php echo $faculty2['subname_university'];
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      if ($sex_type == "MF") {
                        $sql24 = "SELECT * from sport_regis where id_Sports_category='" . $_GET['STID'] . "' 
                          and id_university='" . $_GET['FID'] . "'";
                      } else {
                        $sql24 = "SELECT * from sport_regis where id_Sports_category='" . $_GET['STID'] . "' 
                          and sex='" . $sex_type . "' 
                          and id_university='" . $_GET['FID'] . "'";
