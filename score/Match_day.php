            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="form-group">
                  ...
                  <button class="ui-button ui-widget ui-corner-all btn-<?php if ($date == "2023-02-06") {
                                                                          echo "danger";
                                                                        } else {
                                                                          echo "info";
                                                                        } ?> mb-2" onclick="window.open('index.php?menu=MatchDay&date=2023-02-06','_self')">06</button>
                  <button class="ui-button ui-widget ui-corner-all btn-<?php if ($date == "2023-02-07") {
                                                                          echo "danger";
                                                                        } else {
                                                                          echo "info";
                                                                        } ?> mb-2" onclick="window.open('index.php?menu=MatchDay&date=2023-02-07','_self')">07</button>
                  <button class="ui-button ui-widget ui-corner-all btn-<?php if ($date == "2023-02-08") {
                                                                          echo "danger";
                                                                        } else {
                                                                          echo "info";
                                                                        } ?> mb-2" onclick="window.open('index.php?menu=MatchDay&date=2023-02-08','_self')">08</button>
                  <button class="ui-button ui-widget ui-corner-all btn-<?php if ($date == "2023-02-09") {
                                                                          echo "danger";
                                                                        } else {
                                                                          echo "info";
                                                                        } ?> mb-2" onclick="window.open('index.php?menu=MatchDay&date=2023-02-09','_self')">09</button>
                  <button class="ui-button ui-widget ui-corner-all btn-<?php if ($date == "2023-02-10") {
                                                                          echo "danger";
                                                                        } else {
                                                                          echo "info";
                                                                        } ?> mb-2" onclick="window.open('index.php?menu=MatchDay&date=2023-02-10','_self')">10</button>
