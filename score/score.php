            ...
            <div class="form-group">
              ...
              ?>
                <button class="ui-button ui-widget ui-corner-all btn-<?php if ($date == $dataqr['date']) {
                                                                        ...
                                                                        echo "info";
                                                                      } ?> mb-2" onclick="window.open('index.php?menu=score&date=<?php echo $dataqr['date'] ?>&action=view&ID=<?php echo $_GET['ID'] ?>','_self')"><?php echo $date_d; ?></button>
                      ...
                      <table class="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th width="15%">โปรแกรมแข่งขัน</th>
                            <th>รอบ</th>
                            <th width="5%">สาย</th>
                            <th width="20%">ทีมที่1</th>
                            <th>ผลการแข่งขัน</th>
                            <th width="20%">ทีมที่2</th>
                            <th>เวลา</th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                  <?php echo $arr2['name_Sports_category'].$arr2['sex'];?>
                                </td>
                              <td>
                              ...
                              <td>
                                <?php if ($arr2['faculty_id1'] != "0") { ?>
                                <a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id1']; ?>&STID=<?php echo $arr2['id_Sports_category']; ?>&go=fixture"><?php echo $faculty1['subname_university'];
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <table width="100%" border="0">
                                              <tr>
                                                ...
                                                <td>
                                                  <?php if ($arr2['faculty_id1'] != "0") { ?>
                                                  <a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id1']; ?>&STID=<?php echo $arrsport_type['id_Sports_category']; ?>&go=fixture&sex=M"><?php echo $faculty1['subname_university'];
                                                    if ($arr2['temporary1'] != "ว่าง") {
                                                      echo " (" . $arr2['temporary1'] . " สาย" . $line['line_name'] . ")";
                                                    } ?></a><?php } else {
                                                        echo $arr2['temporary1'];
                                                ...
                                                <td>
                                                  <?php if ($arr2['faculty_id2'] != "0") { ?>
                                                    <a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id2']; ?>&STID=<?php echo $arrsport_type['id_Sports_category']; ?>&go=fixture"><?php echo $faculty2['subname_university'];
                              ...
                              <td>
                                <?php if ($arr2['faculty_id2'] != "0") { ?>
                                  <a href="index.php?menu=result_team&action=view&ID=<?php echo $_GET['ID']; ?>&SVID=<?php echo $arr2['score_vs_id'];?>&FID=<?php echo $arr2['faculty_id2']; ?>&STID=<?php echo $arr2['id_Sports_category']; ?>&go=fixture"><?php echo $faculty2['subname_university'];
                                    if ($arr2['temporary2'] != "ว่าง") {
                                      echo " (" . $arr2['temporary2'] . " สาย" . $line['line_name'] . ")";
                                    } ?></a><?php } else {
                                        echo $arr2['temporary2'];
