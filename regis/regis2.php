...
$checkadd = 0;
$arrsport_type = mysql_fetch_array(mysql_query("SELECT * FROM sport_type WHERE id_Sport_type = '".$_GET['id']."'"));
...
if($_SESSION['admin_st']!="0" )
{
 ...
 else if($_GET['action']=="delect")
 {
   ...
   echo '<SCRIPT language="javascript">
       ...
       window.location="home.php?menu=regis2&tab='; echo $_GET['tab'];  echo '&tab2='; echo $_GET['tab2']; echo '&id='; echo $_GET['id']; echo '";
       </script>';
 }
   ...
   <div class="content-wrapper">
     <div class="content-header row">
       <div class="content-header-left col-md-6 col-12 mb-2">
         <h3 class="content-header-title">ลงทะเบียนทีมการแข่งขัน F2</h3>
         <div class="row breadcrumbs-top">
           <div class="breadcrumb-wrapper col-12">
             <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
               </li>
               <li class="breadcrumb-item"><a href="home.php?menu=showF2">ลงทะเบียนทีมการแข่งขัน F2</a>
               </li>
               <li class="breadcrumb-item"><?php  echo $arrsport_type['name_Sport_type']; ?>
               </li>
             </ol>
           </div>
         </div>
     ...
     <div class="col-xl-12 col-lg-12">
       <div class="card">
         <div class="card-header">
           <h4 class="card-title">ลงทะเบียนทีมการแข่งขัน:<?php  echo $arrsport_type['name_Sport_type']; ?></h4>
         </div>
                       ...
                       <div class="card-body">
                         <ul class="nav nav-tabs nav-linetriangle">
                           ...
                           <li class="nav-item">
                             ...
                             href="#tabIcon3<?php echo $arrsport_type2['id_Sports_category']; ?>1" aria-expanded="true"><i class="la la-user-secret"></i>กดเลือกนักกีฬา ชาย</a>
                           </li>
                         <?php }if( $arrsport_type2['F']==1){ ?>
                           <li class="nav-item">
                             ...
                             href="#tabIcon3<?php echo $arrsport_type2['id_Sports_category']; ?>2" aria-expanded="false"><i class="la la-female"></i>กดเลือกนักกีฬา หญิง</a>
                           </li>
<?php } ?>
                         </ul>
 ...
 <button type="button" class="btn btn-block btn-outline-primary mb-2"  onclick="archiveFunction(<?php echo $arradmin['sport_regis_id'];  ?>,<?php echo $arrsport_type2['id_Sports_category']; ?>,'M',<?php echo $_GET['id']; ?>)"><i class="ft-trash-2"></i> ลบ</button>
                                         </td>
                                                   </tr>
                              ...
                              <div  class="sidebar">
                                 ...
                                 <div class="card">
                                         ...
                                         <div class="card-content collapse show">
                                           <div class="card-body">
                                             <form class="form-horizontal" method="post" action="home.php?menu=regis2&action=add&tab=<?php echo $arrsport_type2['id_Sports_category'] ?>&tab2=M" novalidate>
                                               <div class="row">
                                                 <?php if($countw!=100){ ?>
                         ...
                         <?php }if( $arrsport_type2['F']==1){ ?>
                           <div class="tab-pane <?php if($_GET['tab2']=='F' and $_GET['tab']==$arrsport_type2['id_Sports_category']){echo 'active'; } ?>" id="tabIcon3<?php echo $arrsport_type2['id_Sports_category']; ?>2" aria-labelledby="baseIcon-tab3<?php echo $arrsport_type2['id_Sports_category']; ?>2">
                             <div class="app-content content">
                              ...
                              <button type="button" class="btn btn-block btn-outline-primary mb-2"  onclick="archiveFunction(<?php echo $arradmin['sport_regis_id'];  ?>,<?php echo $arrsport_type2['id_Sports_category']; ?>,'F',<?php echo $_GET['id']; ?>)"><i class="ft-trash-2"></i> ลบ</button>
                                                                      </td>
                                                                                </tr>
                                                       ...
                                                       <?php } ?>
                                                           ...
                                                           <div  class="sidebar">
                                                              ...
                                                              <div class="card">
                                                                      ...
                                                                      <div class="card-content collapse show">
                                                                        <div class="card-body">
                                                                          <form class="form-horizontal" method="post" action="home.php?menu=regis2&action=add&tab=<?php echo $arrsport_type2['id_Sports_category'] ?>&tab2=F" novalidate>
                                                                            <div class="row">
                                                                              <?php if($countw!=100){ ?>
                                                                              <div class="col-lg-12 col-md-12">
...
function(){
 window.location.href="home.php?menu=regis2&tab=<?php echo $_GET['tab']; ?>&tab2=<?php echo $_GET['tab2']; ?>&id=<?php echo $id_Sport_type; ?>";
...
function archiveFunction(id,id2,id3,id4) {
...
function(isConfirm){
if (isConfirm) {
 window.location.href="home.php?menu=regis2&action=delect&checkdel="+id+"&tab="+id2+"&tab2="+id3+"&id="+id4;
