  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">ปริ้นข้อมูล F2 ผู้ดูแลระบบ</h3>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
              </li>
              <li class="breadcrumb-item"><a href="home.php?menu=f1admin">ปริ้นข้อมูล F2</a>
              </li>
            ...
            <div class="card">
              <div class="card-head">
                <div class="card-header">
                  <h4 class="card-title">ปริ้นข้อมูล F2 ผู้ดูแลระบบ</h4>
              ...
              <div class="card-content">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="users-contacts" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataex-basic-initialisation">
                      <thead>
                        <tr>
                          <th>ลำดับ</th>
                          <th>คำนำหน้า</th>
                      ...
                      <tbody>
                        ...
                        LEFT JOIN sports_category c ON r.id_Sports_category = c.id_Sports_category 
                        LEFT JOIN university u ON r.id_university = u.id_university
                        WHERE r.id_Sport_type =  '$_GET[sport_type]'
                        ORDER BY r.id_university, r.sex";
                        ...
                        ?>
                          <tr>
                            <td><?php echo $i;?></td>
                            <td><?php echo $arradmin['title_name']; ?></td>
                            <td><?php echo $arradmin['f_name']; ?></td>
                            <td><?php echo $arradmin['l_name']; ?></td>
                            <td>&nbsp;</td>

                            <td>
                              <?php if($arradmin['sex'] == 'M') {$sex = 'ชาย';} else {$sex = 'หญิง';} 
                              echo $sex;
                              ?>
                            </td>
                            <td><?php echo $arradmin['name_university'];?></td>
                            <td>
                              <?php echo $_GET['sport_name']; ?>
                            </td>
                            <td><?php echo $arradmin['name_Sports_category'].' '.$sex;?></td>
