  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">พิมพ์ข้อมูล F2 ผู้ดูแลระบบ</h3>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
              </li>
              <li class="breadcrumb-item"><a href="home.php?menu=f1admin">พิมพ์ข้อมูล F2</a>
              </li>
            ...
            <div class="card">
              <div class="card-head">
                <div class="card-header">
                  <h4 class="card-title">พิมพ์ข้อมูล F2 ผู้ดูแลระบบ</h4>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-primary btn-sm" onclick="window.open('reportF2admin.php?u_id=<?php echo $arradmin['id_university']; ?>&sport_type=<?php echo $_GET['id']?>&sport_name=<?php echo $_GET['sport_name']?>','_blank')"><i class="la la-print white"></i> พิมพ์</button>
                            </td>
                          </tr>
