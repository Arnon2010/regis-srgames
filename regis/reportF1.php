...
แบบแจ้งความจำนง - ประเภทกีฬา (F1) </b>
	...
	<p style="font-family: thsarabun; font-size: 16pt;">
        ...
        {
          $countgs = mysql_fetch_array(mysql_query("SELECT * FROM tb_f1 WHERE id_Sport_type = '".$arrsport_type['id_Sport_type']."' and id_unversity = '".$_SESSION['university_id']."' and (M='1' or F='1')"));
          if($countgs['id_f1']!="")
          {
        ?>
