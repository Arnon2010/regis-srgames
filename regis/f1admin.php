  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">ปริ้นข้อมูล F1 ผู้ดูแลระบบ</h3>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
              </li>
              <li class="breadcrumb-item"><a href="home.php?menu=f1admin">ปริ้นข้อมูล F1</a>
              </li>
            ...
            <div class="card">
              <div class="card-head">
                <div class="card-header">
                  <h4 class="card-title">ปริ้นข้อมูล F1 ผู้ดูแลระบบ</h4>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php $countf1 = mysql_fetch_array(mysql_query("SELECT COUNT(*) as totalf1 FROM tb_f1 where id_unversity ='" . $arradmin['id_university'] . "' and M='1' and st='0' "));
                                ...
                                ?></td>
                            <td>
                              <button class="btn btn-primary btn-sm" onclick="window.open('reportF1admin.php?u_id=<?php echo $arradmin['id_university']; ?>','_blank')"><i class="la la-print white"></i>PRINT F1</button>
                            </td>
                          </tr>
