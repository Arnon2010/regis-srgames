                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                ...
                                ?>
                                  <?php if ($arrsport['st'] == 0) { ?>
                                    <a href="reportscategory.php?idc=<?php echo $arrsport['id_Sports_category']; ?>&sex=M" target="_blank">
                              ...
                              <td>
                                ...
                                ?>
                                  <?php if ($arrsport['st'] == 0) { ?>
                                    <a href="reportscategory.php?idc=<?php echo $arrsport['id_Sports_category']; ?>&sex=F" target="_blank">
            ...
            <div class="card-content collapse show">
              <div class="card-body">
                ...
                ?>
                  ...
                  <a href="home.php?menu=regisview&id=<?php echo $arrsport_type['id_Sport_type']; ?>" class="btn btn-social width-250 mr-1 mb-1 btn-dropbox">
