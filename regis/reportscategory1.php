...
<?php
$sql3 = "select * from university where id_university = '".$_GET['uni_id']."'";
...
<table width="100%" border="1" cellspacing="0" cellpadding="2">
  <tbody>
	...
	$xi=1;
	if($arr1['st']==0){
$sql4 = "select * from sport_regis where id_Sports_category = '".$_GET['idc']."' && id_university = '".$_GET['uni_id']."' && sex = '".$_GET['sex']."'";
$query4 = mysql_query($sql4,$conn) or die(mysql_error());

	}else{
$sql4 = "select * from sport_regis where id_Sports_category = '".$_GET['idc']."' && id_university = '".$_GET['uni_id']."'";
$query4 = mysql_query($sql4,$conn) or die(mysql_error());
