    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">พิมพ์ข้อมูล ID CARD นักศึกษา</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
                            </li>
                            <li class="breadcrumb-item"><a href="home.php?menu=idcard_student">พิมพ์ข้อมูล ID CARD นักศึกษา</a>
                            </li>
                        ...
                        <div class="card">
                            <div class="card-head">
                                <div class="card-header">
                                    <h4 class="card-title">พิมพ์ข้อมูล ID CARD นักศึกษา</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <!-- <td><?php $countf1 = mysql_fetch_array(mysql_query("SELECT COUNT(*) as totalf1 FROM tb_f1 where id_unversity ='" . $arradmin['id_university'] . "' and M='1' and st='0' "));
                                                            $countf2 = mysql_fetch_array(mysql_query("SELECT COUNT(*) as totalf2 FROM tb_f1 where id_unversity ='" . $arradmin['id_university'] . "' and F='1' and st='0' "));
                                                            $countf3 = mysql_fetch_array(mysql_query("SELECT COUNT(*) as totalf3 FROM tb_f1 where id_unversity ='" . $arradmin['id_university'] . "' and M='1' and F='1' and st='1' "));
                                                            echo $countf1['totalf1'] + $countf2['totalf2'] + $countf3['totalf3'];
                                                            ?></td> -->
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" 
                                                            onclick="window.open('idcard/fpdf/print_idcard_player.php?u_id=<?php echo $arradmin['id_university']; ?>','_blank')"><i class="la la-print white"></i>PRINT IDCARD</button>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-secondary btn-sm" 
                                                                onclick="window.open('home.php?menu=idcard_student_all&u_id=<?php echo $arradmin['id_university']; ?>&u_name=<?php echo $arradmin['name_university']?>','_self')">
