    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">ปริ้นข้อมูล ID CARD ผู้บริหาร</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
                            </li>
                            <li class="breadcrumb-item"><a href="home.php?menu=idcard_student">ปริ้นข้อมูล ID CARD ผู้บริหาร</a>
                            </li>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $arradmin['manager_title']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $arradmin['manager_name']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $arradmin['manager_lastname']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $arradmin['manager_position']; ?>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" 
                                                                onclick="window.open('idcard/fpdf/print_idcard_manager_one.php?m_id=<?php echo $arradmin['manager_id']; ?>','_blank')"><i class="la la-print white"></i>PRINT IDCARD</button>
                                                        </td>
