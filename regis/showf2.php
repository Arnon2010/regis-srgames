         ...
         <div class="row breadcrumbs-top">
           <div class="breadcrumb-wrapper col-12">
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item">ลงทะเบียนทีมการแข่งขัน F2
               </li>
             </ol>
           </div>
         </div>
     ...
     <div class="col-12">
       ...
       <div class="card">
               ...
               <div class="card-content collapse show">
                 <div class="card-body">
                   <?php
   				$sqlsport_type = "SELECT sport_type.id_Sport_type,sport_type.name_Sport_type FROM sport_type INNER JOIN tb_f1 on sport_type.id_Sport_type = tb_f1.id_Sport_type where tb_f1.id_unversity = '".$_SESSION['university_id']."' and (tb_f1.M != '0' or tb_f1.F != '0' )  GROUP BY tb_f1.id_Sport_type";
   				...
   				?>
                 	...
                 	<a href="home.php?menu=regis2&id=<?php  echo $arrsport_type['id_Sport_type']; ?>" class="btn btn-social width-250 mr-1 mb-1 btn-dropbox">
