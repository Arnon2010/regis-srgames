  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">พิมพ์รายชื่อผู้เข้าร่วม: บุคลากร</h3>
            ...
            <div class="card">
              <div class="card-head">
                <div class="card-header">
                  <h4 class="card-title">รายชื่อผู้เข้าร่วม: บุคลากร</h4>
                          ...
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-primary btn-sm" 
                                onclick="window.open('report_personnel_pdf.php?u_id=<?php echo $arradmin['id_university']; ?>','_blank')"><i class="la la-print white"></i> PRINT</button>
                            </td>
                            <td>
                              <button class="btn btn-success btn-sm" 
                                onclick="window.open('report_personnel_excel.php?u_id=<?php echo $arradmin['id_university']; ?>&u_name=<?php echo $arradmin['subname_university']; ?>','_blank')"><i class="la la-print white"></i> EXCEL</button>
                            </td>
                          </tr>
