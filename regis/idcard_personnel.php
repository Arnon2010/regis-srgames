    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">พิมพ์ข้อมูล ID CARD บุคลากร</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
                            </li>
                            <li class="breadcrumb-item"><a href="home.php?menu=idcard_student">พิมพ์ข้อมูล ID CARD บุคลากร</a>
                            </li>
                        ...
                        <div class="card">
                            <div class="card-head">
                                <div class="card-header">
                                    <h4 class="card-title">พิมพ์ข้อมูล ID CARD บุคลากร</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" onclick="window.open('idcard/fpdf/print_idcard_personnel.php?u_id=<?php echo $arradmin['id_university']; ?>','_blank')"><i class="la la-print white"></i>PRINT IDCARD</button>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-secondary btn-sm" 
                                                                onclick="window.open('home.php?menu=idcard_personnel_all&u_id=<?php echo $arradmin['id_university']; ?>&u_name=<?php echo $arradmin['name_university']?>','_self')">
