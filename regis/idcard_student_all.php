    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">ปริ้นข้อมูล ID CARD นักศึกษา</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
                            </li>
                            <li class="breadcrumb-item"><a href="home.php?menu=idcard_student">ปริ้นข้อมูล ID CARD นักศึกษา</a>
                            </li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="users-contacts" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                                            ...
                                            <tbody>
                                                ...
                                                where id_university = '$_GET[u_id]' AND st = '9'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" 
                                                                onclick="window.open('idcard/fpdf/print_idcard_player_one.php?s_id=<?php echo $arradmin['id_student']; ?>','_blank')"><i class="la la-print white"></i>PRINT IDCARD</button>
                                                        </td>
