...
$checkadd = 0;
 ...
 if($_GET['action']=="add")
 {
  ...
  '$education_level','$year_level','$faculty','','','','','','$status_vaccine_covid19','$st','$st_date','$id_user_admin','','')";
   $objQuery = mysql_query($strSQL);
			...
			$ext6 = strtolower(end(explode('.',$pic_vaccine_covid19_name)));

			
			if($_FILES['pic_card']['name']!=""){
			$filename1=$id_max."pic_card.".$ext1;
			}else{ $filename1="";}
			
			if($_FILES['pic_student']['name']!=""){
			$filename2=$id_max."pic_student.".$ext2;
			}else{ $filename2="";}
			
			if($_FILES['pic_cardstudent']['name']!=""){
			$filename3=$id_max."pic_cardstudent.".$ext3;
			}else{ $filename3="";}
			
			if($_FILES['evidence']['name']!=""){
			$filename4=$id_max."evidence.".$ext4;
			}else{ $filename4="";}
			
			if($_FILES['evidence1']['name']!=""){
			$filename5=$id_max."evidence1.".$ext5;
			}else{ $filename5="";}

			if($_FILES['pic_vaccine_covid19']['name']!=""){
				$filename6=$id_max."pic_vaccine_covid19.".$ext6;
			}else{ $filename6="";}
 ...
 else if($_GET['action']=="edit")
 {
	...
	$pic_cardstudent_type=$_FILES['pic_cardstudent']['type'];
			...
			$filename = $id_max."pic_cardstudent.".$ext;
	...
	$pic_student_type=$_FILES['pic_student']['type'];
			...
			$filename = $id_max."pic_student.".$ext;
	...
	if($_FILES['pic_vaccine_covid19']['name']!=""){
		...
		$pic_vaccine_covid19_type=$_FILES['pic_vaccine_covid19']['type'];
				...
				$filename = $id_max."pic_vaccine_covid19.".$ext;
...
function(){
 window.location.href="home.php?menu=playeradmin";
