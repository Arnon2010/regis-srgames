    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">ปริ้นข้อมูล ID CARD บุคลากร</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a>
                            </li>
                            <li class="breadcrumb-item"><a href="home.php?menu=idcard_student">ปริ้นข้อมูล ID CARD บุคลากร</a>
                            </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="users-contacts" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqladmin = "SELECT * from personnel p
                                                left join type_user t ON  p.type_user = t.id_type_user
                                                where p.id_university = '$_GET[u_id]' 
                                                and personnel_st = '0'
                                                group by p.personnel_name, p.personnel_lastname ASC";
                                                $i = 0;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $arradmin['personnel_title']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $arradmin['personnel_name']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $arradmin['personnel_lastname']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $arradmin['name_type_user']; ?>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-primary btn-sm" 
                                                                onclick="window.open('idcard/fpdf/print_idcard_personnel_one.php?p_id=<?php echo $arradmin['personnel_id']; ?>','_blank')"><i class="la la-print white"></i>PRINT IDCARD</button>
                                                        </td>
