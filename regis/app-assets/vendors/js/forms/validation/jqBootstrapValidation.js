    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "สั้นเกินไป ต้องมากว่า '" + $this.attr("minlength") + "' ตัวอักษร<!-- data-validation-minlength-message to override -->";
        ...
        validatorTypes: {
            ...
            match: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "ยืนยันรหัสผ่านไม่ถูกต้อง";
                    var $label = null;
            ...
            minlength: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "สั้นเกินไป ต้องมากว่า '" + result.minlength + "' ตัวอักษร";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
        ...
        builtInValidators: {
            ...
            required: {
                name: "Required",
                type: "required",
                message: "กรุกรุณากรอกข้อมูล<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
